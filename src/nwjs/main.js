...
// });
// in freedom-for-chrome.js, change {source : findSrc} to {source : window.location.origin + '/freedom-for-chrome/freedom-for-chrome.js'}
require('./freedom-for-chrome/freedom-for-chrome');
